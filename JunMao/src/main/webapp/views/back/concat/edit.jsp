   ...
   <div class="container-fluid">
       <div class="row-fluid">
		...
		<div class="well">
		  ...
		  <sf:form method="post" modelAttribute="email" cssClass="form-horizontal">
		  	<div class="form-group">
				...
				<div class="col-md-4">
					<sf:errors path="username" cssClass="help-block error"/>
				</div>
		  	</div>
		  	<div class="form-group">
			 ...
			 <div class="form-group">
			  ...
			  <div class="form-group">
					...
					<div class="col-md-4">
						<sf:errors path="remark" cssClass="help-block error"/>
					</div>
			 </div>
			 <div class="form-group">
