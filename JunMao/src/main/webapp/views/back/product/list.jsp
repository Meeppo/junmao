...
<script>
	...
	$(document).ready(function(){
		...
		init(table,{
			del:{url:"${root}/product/back/delete"},
			view:{has:true,url:"${root}/product/back/view"}
		});
			...
			<div class="row-fluid">
				<div class="btn-toolbar">
				  <div class="btn-group">
				  	...
				  	<a href="/JunMao/product/add" class="btn btn-primary">添加产品</a>
				  </div>
				</div>
				<div class="well">
				    <table class="table table-striped table-hover">
				      ...
				      <tbody>
				      <c:forEach items="${productList }" var="var" varStatus="status">
				        <tr>
				          <td>${var.id }</td>
				          ...
				          <td>${var.summary }</td>
				          <td>
				              <a href="${root }/product/back/update/${var.id}"><i class="icon-pencil"></i></a>
